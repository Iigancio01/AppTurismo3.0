        ...
        <div class="row">
            <aside class="barra-lateral col-auto p-0">
                ...
                <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
                    ...
                    <a href="Controlador?accion=listarDep">
            ...
            <main class="main col">
                ...
                <br>
                <br>
                <a class="btn btn-success" href="Controlador?accion=addDep">Agregar nuevo</a>
                <br>
                <br>
                <table class="table table-bordered">
                    ...
                    <%
                       ...
                       List<Departamentos>list=dao.listar();
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning" href="Controlador?accion=editarDep&IdDepartamento=<%=dpto.getIdDepartamento()%>">Editar</a>
                                <a class="btn btn-danger" href="Controlador?accion=eliminarDep&IdDepartamento=<%=dpto.getIdDepartamento()%>">Eliminar</a>
                            </td>
                        </tr>
                        <%}%>
                    </tbody>
